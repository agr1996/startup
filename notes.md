...
base specifies the baseURL/target for all relative URLs in a document
...
colgroup specifies the group of one of more columns in a table for formatting
...
dfn specifies a term that is going th be defined within the content
...
fieldset groups related elemtns in a form
...
ruby defines a ruby annotation (for east asian topography)
